 ...
 var zuukaMatchers = require("./assertions/index.js"),
...
/**
Initialise the zuuka package with custom chai plugins. This is no longer recommended, instead use either addMethod, addProperty or addRawPlugin.
@deprecated since 0.2.0
@param {...ChaiPlugin} customChaiPlugin - One or multiple chai plugins
@alias module:zuuka.initialize
@example 
...
zuuka.initialise(customProperty);
 */
exports.initialize = function (customChaiPlugin) {
    ...
    zuukaMatchers.map(function (matcher) {
...
/**
Add a raw chai plugin to zuuka. See Chai's documentation for more details.
...
@alias module:zuuka.addRawPlugin
@example 
...
/**
Add a new property assertion to zuuka. Properties should be used over methods when there is no arguments required for the assertion.  
@param {String} name - The plugin's name, used as an identifier
@param {function} plugin - A function which should accept one argument; a {@link zuukaResponse} object
@alias module:zuuka.addProperty
@example 
...
/**
Add a new method assertion to zuuka. Methods should be used when the assertion requires parameters.  
@param {String} name - The plugin's name, used as an identifier
@param {function} plugin - A function which should accept one or more arguments. The first argument will be a {@link zuukaResponse} object, followed by any arguments passed into the assertion.
@alias module:zuuka.addMethod
@example 
