...
@returns {Promise} Promise which will resolve to a {@link zuukaResponse} object
@alias module:zuuka.request
@example
var request = zuuka.request("GET", "http://httpbin.org/get", {
...
/**
Alias for zuuka.delete. Perform HTTP DELETE request.
@param {string} url - fully qualified url
@param {Object} [data] - a JSON serializable object (unless json is set to false in params, in which case this should be a buffer or string)
@param {Object} [params] - additional request options, see the popular {@link https://github.com/request/request#requestoptions-callback request library} for options
@returns {Promise} Promise which will resolve to a {@link zuukaResponse} object
@alias module:zuuka.del
 */
...
@alias module:zuuka.setRequestDefaults
 */
...
@alias module:zuuka.clearRequestDefaults
 */
