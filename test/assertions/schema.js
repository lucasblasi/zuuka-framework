...
describe("zuuka Assertions", function() {
    describe("JSON Schema", function() {
        ...
        before(function() {
            getRequest = zuuka.get("http://httpbin.org/get");
            postRequest = zuuka.post("http://httpbin.org/post", {
        ...
        describe("registering schemas", function () {
            ...
            it("should be able to validate pre-registered schemas", function () {
                zuuka.addSchema("https://github.com/lucasblasi/zuuka/testschema/person-array", personArraySchema);
                zuuka.addSchema({
                    id: "https://github.com/lucasblasi/zuuka/testschema/string-array",
                    pattern: /test\d/
                });
                return expect(postRequest).to.have.schema('json', {
                    properties: {
                        stringArray: {
                            items: {
                                $ref: "https://github.com/lucasblasi/zuuka/testschema/string-array"
                            }
                        },
                        objectArray: {
                            $ref: "https://github.com/lucasblasi/zuuka/testschema/person-array"
                        }
                    }
                });
            });
            ...
            it("should fail assertions with unknown schemas", function () {
                return expect(postRequest).not.to.have.schema('json', {
                    id: "https://github.com/lucasblasi/zuuka/testschema2",
                    properties: {
                        objectArray: {
                            $ref: "https://github.com/lucasblasi/zuuka/testschema/person-array-not-registered#"
                        }
                    }
                });
            });
